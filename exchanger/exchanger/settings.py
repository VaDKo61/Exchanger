...
SECRET_KEY = environ.get('DJANGO_SECRET_KEY', 'django-insecure-axnx00d12w%tr8s*m7()l8e4rujwru(m7y1iw01vva*2s@beco')
...
DATABASES = {
    'default': {
        ...
        'NAME': environ.get('DATABASE_NAME', 'exchanger_test'),
        'USER': environ.get('DATABASE_USERNAME', 'postgres'),
